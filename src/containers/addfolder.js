...
class AddNotes extends Component {
    ...
    _add = () => {
        this.props.dispatch(AddFolderAction({name:this.input.content}));
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                <TextInput autoCapitalize='none' onChangeText={(text) => { this.input.content = text; } } style={styles.textInput} autoCorrect={false} multiline={true} placeholder="清单名称" />
